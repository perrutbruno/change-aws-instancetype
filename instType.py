...
def change_instancetype(instanceid):
    ...
    client.modify_instance_attribute(InstanceId=instanceid, Attribute='instanceType', Value='m5.large')
    f = open("logs.txt", "a")
    f.write(f"instancia {instanceid} trocado instancetype para m5.large!")
    f.close()
